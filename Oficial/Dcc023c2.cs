...
namespace DCCNET_TP0
{
    public class Dcc023c2
    {
        ...
        public static int WAIT_FRAME_TIMEOUT = 1000;
        ...
        public static class AsynchronousClient
        {
            ...
            public static void StartClient(string ip, string port)
            {
                try
                {
                    ...
                    client.ReceiveTimeout = WAIT_FRAME_TIMEOUT;
        ...
        public static class AsynchronousSocketServer
        {
            ...
            public static void StartListening(string port)
            {
                ...
                listener.ReceiveTimeout = WAIT_FRAME_TIMEOUT;
            ...
            public static void DCCNET(Socket socket)
            {
                ...
                while (true)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (sw.ElapsedMilliseconds > WAIT_FRAME_TIMEOUT)
                        {
                            Console.WriteLine("Burst timeout - " + WAIT_FRAME_TIMEOUT / 1000 + "s");
                        ...
                        {
                            Console.WriteLine("Timeout receive message - Resend - Time elapsed: " + WAIT_FRAME_TIMEOUT / 1000 + "s");
                            break;
                        }
